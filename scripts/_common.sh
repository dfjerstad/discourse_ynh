...
# Returns true if swappiness higher than 29
# usage: is_swappiness_sufficient
is_swappiness_sufficient() {
  [ $(cat /proc/sys/vm/swappiness)  -gt 29 ]
}
...
check_memory_requirements() {
  if ! is_swap_present ; then
    ...
    ynh_die --message="Your swappiness must be higher than 29; please see https://en.wikipedia.org/wiki/Swappiness"
